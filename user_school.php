            ...
            <div id="content">
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            <?php
                            $query = mysqli_query($con,"select * from tb_products WHERE category = 'School'") or die(mysql_error());
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <li class="span3">
                                    ...
                                    if (isset($_POST['order'])) {
                                        ...
                                        mysqli_query($con,"insert into order_details (memberID,qty,productID,price,total,status) values('$member_id','$quantity','$product_id','$price','$total','Pending')") or die(mysql_query);
