						...
						<div class="hero-unit-table">   
                             <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $cart_table =  mysqli_query($con,"select  * from order_details where status='Pending'") or die(mysqli_error());
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
										...
										$member_query =  mysqli_query($con,"select * from tb_member where memberID = '$member_id'")or die(mysqli_error());
