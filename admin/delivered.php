						...
						<div class="hero-unit-table">   
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $cart_table =  mysqli_query($con,"select  * from order_details where status='Delivered'") or die(mysql_error());
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
                                        ...
                                        $product_query =  mysqli_query($con,"select * from tb_products where productID='$product_id'") or die(mysql_error());
                                        $product_row = mysqli_fetch_array($product_query);
										$member_query =  mysqli_query($con,"select * from tb_member where memberID = '$member_id'")or die(mysql_error());
