                    ...
                    <div id="body">
                        ...
                        <div class="hero-unit-table">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $cart_table = mysqli_query($con,"select  * from order_details where memberID='$ses_id' and status='Pending'") or die(mysqli_error());
                        ...
                        <?php
                        if ($cart_count != 0) {
                            $result = mysqli_query($con,"SELECT sum(total) FROM order_details WHERE memberID='$ses_id' and status = 'Pending'") or die(mysqli_error());
