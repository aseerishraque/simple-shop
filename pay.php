...
/*  mysqli_query("update order_details set status='Pending',transaction_code='$confirmation',modeofpayment='Online' where MemberID='$get_id'")or die(mysql_error());
 */
                    ...
                    <div id="body">
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"  method="post">
                            ...
                            <input type="hidden" name="item_name" value="Bags" />
                               ...
                               <?php
                                    $cart_table =  mysqli_query($con,"select  * from order_details where memberID='$ses_id'") or die(mysqli_error());
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
                                        ...
                                        $product_query =  mysqli_query($con,"select * from tb_products where productID='$product_id'") or die(mysqli_error());
                           ...
                           <?php } ?>
                            ...
                            <?php
                            if ($cart_count != 0) {
                                $result =  mysqli_query($con,"SELECT sum(total) FROM order_details WHERE memberID='$ses_id' and status = ''") or die(mysql_error());
